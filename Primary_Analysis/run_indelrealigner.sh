...
#tumor_bam=${data_path}/${project}/${subject}/${sample}/${sample}.aligned.duplicate_marked
...
-R ${ref_fasta} \
-I ${tumor_bam} \
-o ${tumor_bam}.realign_target.intervals
...
-T IndelRealigner \
-R ${ref_fasta} \
-targetIntervals ${tumor_bam}.realign_target.intervals \
--noOriginalAlignmentTags \
-I ${tumor_bam} \
-o ${tumor_bam}.IndelRealigned.bam

#}
#fi

# sort deduplicated & realigned bam
${tool_path}/samtools sort -m ${mem_limit} --threads ${samtools_threads} -l ${compression_level} ${tumor_bam}.IndelRealigned.bam -o ${SORT_BAM} 
