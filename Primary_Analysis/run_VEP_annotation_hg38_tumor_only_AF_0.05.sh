...
VEPInputVcf=${sample}.aligned.duplicates_marked.recalibrated.targeted_sequencing.somvarius.tumor_only.sorted.rm_dbsnps.vcf
...
gzip -cd ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf}.gz > ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf}
...
bcftools view -i 'INFO/DP > 10 & INFO/AF > 0.05 & INFO/BQ > 20 & INFO/MQ > 50' ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf} > ${data_path}/${project}/${subject}/${sample}/${VEPInputVcf/.vcf/.AF0.05_BQ20_MQ50.vcf} 
...
bcftools view -i 'INFO/DP > 10 & INFO/AF > 0.05 & INFO/BQ > 20 & INFO/MQ > 50'  > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.non_synonymous_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t%AF\t[%GT\t]\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.non_synonymous_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.non_synonymous_variant_only.query}

singularity exec --bind ${data_path}/${project}/${subject}/${sample}:/data \
/data/ldiaz/luol2/ensembl-vep.sif \
filter_vep -i /data/${VEPOutputVcf} --filter "Consequence is missense_variant" | \
bcftools view -i 'INFO/DP > 10 & INFO/AF > 0.05 & INFO/BQ > 20 & INFO/MQ > 50' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.missense_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t%AF\t[%GT\t]\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.missense_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.missense_variant_only.query}

singularity exec --bind ${data_path}/${project}/${subject}/${sample}:/data \
/data/ldiaz/luol2/ensembl-vep.sif \
filter_vep -i /data/${VEPOutputVcf} --filter "Consequence is frameshift_variant" | \
bcftools view -i 'INFO/DP > 10 & INFO/AF > 0.05 & INFO/BQ > 20 & INFO/MQ > 50' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.frameshift_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t%AF\t[%GT\t]\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.frameshift_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.frameshift_variant_only.query}

singularity exec --bind ${data_path}/${project}/${subject}/${sample}:/data \
/data/ldiaz/luol2/ensembl-vep.sif \
filter_vep -i /data/${VEPOutputVcf} --filter "Consequence is synonymous_variant" | \
bcftools view -i 'INFO/DP > 10 & INFO/AF > 0.05 & INFO/BQ > 20 & INFO/MQ > 50' > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.synonymous_variant_only.vcf}
bcftools query -f "%CHROM\t%POS\t%REF\t%ALT{0}\t%DP\t%AF\t[%GT\t]\t\n" ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.synonymous_variant_only.vcf} > ${data_path}/${project}/${subject}/${sample}/${VEPOutputVcf/.ann.vcf/.ann.AF0.05_BQ20_MQ50.synonymous_variant_only.query}
